...
(cl:defmethod frameid-val ((m <Person>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader learning_communication-msg:frameid-val is deprecated.  Use learning_communication-msg:frameid instead.")
  (frameid m))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<Person>)))
  ...
  "55f8cb470a78b4e77370a2ffc3faded1")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'Person)))
  "Returns md5sum for a message object of type 'Person"
  "55f8cb470a78b4e77370a2ffc3faded1")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<Person>)))
  ...
  (cl:format cl:nil "# metadata~%uint32 seq~%time stamp~%string frameid~%# custom msgs~%string name~%uint8 sex~%uint8 age~%uint8 unknown = 0~%uint8 male = 1~%uint8 female = 2~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'Person)))
  "Returns full string definition for message of type 'Person"
  (cl:format cl:nil "# metadata~%uint32 seq~%time stamp~%string frameid~%# custom msgs~%string name~%uint8 sex~%uint8 age~%uint8 unknown = 0~%uint8 male = 1~%uint8 female = 2~%~%~%"))
